...
export const loginAPICall = (payload) => axios.post('https://movie-app-backend-oqma.onrender.com', payload);
export const signupAPICall = (payload) => axios.post('https://movie-app-backend-oqma.onrender.com', payload);
